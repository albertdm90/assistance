(self["webpackChunkionic_finger_scanner_app"] = self["webpackChunkionic_finger_scanner_app"] || []).push([["common"],{
...
let RoundService = class RoundService {
    constructor(httpClient) {
        ...
        this.url = `${src_endpoint__WEBPACK_IMPORTED_MODULE_0__.endpoint}/round`;
        this.wor_id_number = '';
        this.wor_pin = '';
        this.httpOptions = {
    ...
    indexCheckPoints() {
        return this.httpClient.get(`${src_endpoint__WEBPACK_IMPORTED_MODULE_0__.endpoint}/chekpoints`).pipe((0,rxjs_operators__WEBPACK_IMPORTED_MODULE_2__.map)((res) => {
...
RoundService.ctorParameters = () => [
    { type: _angular_common_http__WEBPACK_IMPORTED_MODULE_1__.HttpClient }
];
RoundService = (0,tslib__WEBPACK_IMPORTED_MODULE_3__.__decorate)([
...
/* harmony export */ });
const endpoint = "http://localhost:8888/assistance/v1/api";
